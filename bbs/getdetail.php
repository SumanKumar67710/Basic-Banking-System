...
<body>
    ...
    <table class="flat-table-1">
		...
		<tr>
			...
			<td>
				<form action="user.php" method="post"  class="view">
					<button class="button1" type="submit" name="name" value="Ranjan">View</button>
				</form>
			</td>
		</tr>
		<tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Anwar">View</button>
				</form>
			</td>
		</tr>
        <tr>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Harshad">View</button>
				</form>
			</td>
        </tr>
        <tr>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Ravi">View</button>
				</form>
			</td>
		</tr>
        <tr>
