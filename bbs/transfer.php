		 ...
		 function random_function()
            {
				...
				if(a==="Ranjan"){
				 var arr=["Anwar","Priyanka","Akash","Pankaj","Harshad","Shreya","Ravi","Deepak","Vaishnavi"];
				 }
				 else if(a==="Anwar"){
					var arr=["Ranjan","Priyanka","Akash","Pankaj","Harshad","Shreya","Ravi","Deepak","Vaishnavi"];
				}
				else if(a==="Priyanka"){
					var arr=["Ranjan","Anwar","Akash","Pankaj","Harshad","Shreya","Ravi","Deepak","Vaishnavi"];
				}
				else if(a==="Akash"){
					var arr=["Ranjan","Anwar","Priyanka","Pankaj","Harshad","Shreya","Ravi","Deepak","Vaishnavi"];
				 }
				 else if(a==="Pankaj"){
					var arr=["Ranjan","Anwar","Priyanka","Akash","Harshad","Shreya","Ravi","Deepak","Vaishnavi"];
				 }
				 else if(a==="Harshad"){
					var arr=["Ranjan","Anwar","Priyanka","Akash","Pankaj","Shreya","Ravi","Deepak","Vaishnavi"];
				 }
				 else if(a==="Shreya"){
					var arr=["Ranjan","Anwar","Priyanka","Akash","Pankaj","Harshad","Ravi","Deepak","Vaishnavi"];
				 }
				 else if(a==="Ravi"){
					var arr=["Ranjan","Anwar","Priyanka","Akash","Pankaj","Harshad","Shreya","Deepak","Vaishnavi"];
				 }
				 else if(a==="Deepak"){
					var arr=["Ranjan","Anwar","Priyanka","Akash","Pankaj","Harshad","Shreya","Ravi","Vaishnavi"];
				 }
				 else if(a==="Vaishnavi"){
				 var arr=["Ranjan","Anwar","Priyanka","Akash","Pankaj","Harshad","Shreya","Ravi","Deepak"];
				 }
                var string="";
